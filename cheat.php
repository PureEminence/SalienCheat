...
function GetCurl( )
{
	...
	curl_setopt_array( $c, [
		CURLOPT_USERAGENT      => $SaliensUserAgent ? 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3464.0 Safari/537.36' : 'SalienCheat (https://github.com/mystith/SalienCheat/)',
